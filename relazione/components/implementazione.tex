...
% --------- ripetizione? in realtà prima l'attenzione era su parser e ora su renderer, mi fido delle vostre modifiche
...
%------ ...questa condizione si verifichi è estremamente bassa... - Potrebbe triggerare la prof?
...
\paragraph{Menu mobile} % se il js è disattivato il menù si vede lo stesso in mobile?
